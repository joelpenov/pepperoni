    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory_move', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='details', to='inventory.InventoryMove')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.AddField(
            ...
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inventory_move_details', to='inventory.Product'),
        ),
        migrations.AddField(
